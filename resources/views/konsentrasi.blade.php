            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="pb-5" data-aos="fade-right">
                        <h5 class="pb-2">{{ $konsentrasiShow->namaKonsentrasi }}</h5>
                        <div class="pb-2">
                            <p>{!! $konsentrasiShow->deskripsiKonsentrasi !!}</p>
                        </div>
                        <div class="pb-2">
                            <h6 class="border-bottom pb-2 fst-italic fw-normal">
                                Keunggulan {{ $konsentrasiShow->namaKonsentrasi }}
                            </h6>
                            <p>{!! $konsentrasiShow->keunggulanKonsentrasi !!}</p>
                        </div>
                        <h6 class="border-bottom pb-2 fst-italic fw-normal">
                            Apa Saja Yang Dipelajari Di {{ $konsentrasiShow->namaKonsentrasi }}
                        </h6>
                        <p>{!! $konsentrasiShow->dipelajariKonsentrasi !!}</p>
                    </div>
                </div>
