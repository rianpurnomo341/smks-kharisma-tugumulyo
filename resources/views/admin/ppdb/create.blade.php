...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/ppdb') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" id="deskripsiPpdb" name="deskripsiPpdb" value="{{ old('deskripsiPpdb') }}">
