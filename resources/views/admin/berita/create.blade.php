...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/berita') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" id="deskripsiBerita" name="deskripsiBerita" value="{{ old('deskripsiBerita') }}">
                    <trix-editor input="deskripsiBerita" class="@error('deskripsiBerita') border border-danger @enderror"></trix-editor>
