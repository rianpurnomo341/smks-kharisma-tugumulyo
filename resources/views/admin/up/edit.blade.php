...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/up/' . Crypt::encryptString($up->idUkk)) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('judulUkk') is-invalid @enderror" name="judulUkk"
                        value="{{ old('judulUkk', $up->judulUkk) }}">
                    @error('judulUkk')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="hidden" id="deskripsiUkk" name="deskripsiUkk"
                        value="{{ old('deskripsiUkk', $up->deskripsiUkk) }}">
