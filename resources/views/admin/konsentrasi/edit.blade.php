...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/konsentrasi/' . Crypt::encryptString($konsentrasi->idKonsentrasi)) }}"
                method="POST">
                @method('PUT')
                @csrf
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('namaKonsentrasi') is-invalid @enderror"
                        name="namaKonsentrasi" value="{{ old('namaKonsentrasi', $konsentrasi->namaKonsentrasi) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" id="deskripsiKonsentrasi" name="deskripsiKonsentrasi"
                        value="{{ old('deskripsiKonsentrasi', $konsentrasi->deskripsiKonsentrasi) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" id="keunggulanKonsentrasi" name="keunggulanKonsentrasi"
                        value="{{ old('keunggulanKonsentrasi', $konsentrasi->keunggulanKonsentrasi) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" id="dipelajariKonsentrasi" name="dipelajariKonsentrasi"
                        value="{{ old('dipelajariKonsentrasi', $konsentrasi->dipelajariKonsentrasi) }}">
