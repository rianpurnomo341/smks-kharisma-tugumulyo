...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/ts/' . Crypt::encryptString($ts->idTs)) }}" method="POST"
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" id="deskripsiTs" name="deskripsiTs"
                        value="{{ old('deskripsiTs', $ts->deskripsiTs) }}">
