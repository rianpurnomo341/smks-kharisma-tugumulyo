...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/bkk') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="hidden" id="deskripsiBkk" name="deskripsiBkk" value="{{ old('deskripsiBkk') }}">
