...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ url('/admin/kategori-pengumuman') }}" method="POST" autocomplete="off">
                @csrf
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('judulKategoriPengumuman') is-invalid @enderror" name="judulKategoriPengumuman"
                        value="{{ old('judulKategoriPengumuman') }}">
                    @error('judulKategoriPengumuman')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-4">
                    <label class="form-label">Deskripsi Kategori Pengumuman</label>
                    <input type="hidden" id="deskripsiKategoriPengumuman" name="deskripsiKategoriPengumuman" value="{{ old('deskripsiKategoriPengumuman') }}">
