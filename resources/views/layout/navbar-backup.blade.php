            ...
            <ul class="navbar-nav ms-auto" id="scrol-active">
                ...
                <li class="px-2 dropdown {{ Request::is('profil*') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <small><a class="dropdown-item" href="{{ url('/profil/visi-misi-tujuan') }}">Visi, Misi dan
                                    Tujuan</a></small>
                        </li>
                        <li>
                            <small><a class="dropdown-item" href="{{ url('/profil/struktur-sekolah') }}">Struktur
                                    Sekolah</a></small>
                        </li>
                        <li>
                            <small><a class="dropdown-item" href="{{ url('/profil/guru-staff') }}">Guru dan
                                    Staff</a></small>
                        </li>
                    </ul>
                </li>
