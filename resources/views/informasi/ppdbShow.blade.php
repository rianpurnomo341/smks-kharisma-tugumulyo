    ...
    <div class="container my-5">
        <div class="py-5">
            <div class="my-4 opacity-75 text-success" data-aos="fade-down">
                Home <i class="bi bi-chevron-right pe-1" style="font-size: 12px"></i> PPDB <i
                ...
                <div class="col-md-8">
                    <div class="pb-5" data-aos="fade-right">
                        <div class="mb-3">
                            ...
                            <small class="fs-6 opacity-75">{{ $ppdb->updated_at->format('d M Y') }}</small>
                        </div>
